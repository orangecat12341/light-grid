...
const pixe4 = document.getElementById("pick4");

function setPixel(pixelId) {
    colorToSet = document.getElementById('paintbrush').value;
    pixelId.style.backgroundColor = colorToSet;
    pixelId.value = colorToSet;
    send_updated_pixels();
};
...
socket.on('color_grid', (grid) => {
    console.log(grid)
    pixel1.value = grid[0]; pixel1.style.backgroundColor = grid[0];
    pixel2.value = grid[1]; pixel2.style.backgroundColor = grid[1];
    pixel3.value = grid[2]; pixel3.style.backgroundColor = grid[2];
    pixel4.value = grid[3]; pixel4.style.backgroundColor = grid[3];
    pixel5.value = grid[4]; pixel5.style.backgroundColor = grid[4];
    pixel6.value = grid[5]; pixel6.style.backgroundColor = grid[5];
    pixel7.value = grid[6]; pixel7.style.backgroundColor = grid[6];
    pixel8.value = grid[7]; pixel8.style.backgroundColor = grid[7];
    pixel9.value = grid[8]; pixel9.style.backgroundColor = grid[8];
    pixel10.value = grid[9]; pixel10.style.backgroundColor = grid[9];
    pixel11.value = grid[10]; pixel11.style.backgroundColor = grid[10];
    pixel12.value = grid[11]; pixel12.style.backgroundColor = grid[11];
    pixel13.value = grid[12]; pixel13.style.backgroundColor = grid[12];
    pixel14.value = grid[13]; pixel14.style.backgroundColor = grid[13];
    pixel15.value = grid[14]; pixel15.style.backgroundColor = grid[14];
    pixel16.value = grid[15]; pixel16.style.backgroundColor = grid[15];
    pixel17.value = grid[16]; pixel17.style.backgroundColor = grid[16];
    pixel18.value = grid[17]; pixel18.style.backgroundColor = grid[17];
    pixel19.value = grid[18]; pixel19.style.backgroundColor = grid[18];
    pixel20.value = grid[19]; pixel20.style.backgroundColor = grid[19];
    pixel21.value = grid[20]; pixel21.style.backgroundColor = grid[20];
    pixel22.value = grid[21]; pixel22.style.backgroundColor = grid[21];
    pixel23.value = grid[22]; pixel23.style.backgroundColor = grid[22];
    pixel24.value = grid[23]; pixel24.style.backgroundColor = grid[23];
    pixel25.value = grid[24]; pixel25.style.backgroundColor = grid[24];
    pixel26.value = grid[25]; pixel26.style.backgroundColor = grid[25];
    pixel27.value = grid[26]; pixel27.style.backgroundColor = grid[26];
    pixel28.value = grid[27]; pixel28.style.backgroundColor = grid[27];
    pixel29.value = grid[28]; pixel29.style.backgroundColor = grid[28];
    pixel30.value = grid[29]; pixel30.style.backgroundColor = grid[29];
    pixel31.value = grid[30]; pixel31.style.backgroundColor = grid[30];
    pixel32.value = grid[31]; pixel32.style.backgroundColor = grid[31];
    pixel33.value = grid[32]; pixel33.style.backgroundColor = grid[32];
    pixel34.value = grid[33]; pixel34.style.backgroundColor = grid[33];
    pixel35.value = grid[34]; pixel35.style.backgroundColor = grid[34];
    pixel36.value = grid[35]; pixel36.style.backgroundColor = grid[35];
    pixel37.value = grid[36]; pixel37.style.backgroundColor = grid[36];
    pixel38.value = grid[37]; pixel38.style.backgroundColor = grid[37];
    pixel39.value = grid[38]; pixel39.style.backgroundColor = grid[38];
    pixel40.value = grid[39]; pixel40.style.backgroundColor = grid[39];
    pixel41.value = grid[40]; pixel41.style.backgroundColor = grid[40];
    pixel42.value = grid[41]; pixel42.style.backgroundColor = grid[41];
    pixel43.value = grid[42]; pixel43.style.backgroundColor = grid[42];
    pixel44.value = grid[43]; pixel44.style.backgroundColor = grid[43];
    pixel45.value = grid[44]; pixel45.style.backgroundColor = grid[44];
    pixel46.value = grid[45]; pixel46.style.backgroundColor = grid[45];
    pixel47.value = grid[46]; pixel47.style.backgroundColor = grid[46];
    pixel48.value = grid[47]; pixel48.style.backgroundColor = grid[47];
    pixel49.value = grid[48]; pixel49.style.backgroundColor = grid[48];
    pixel50.value = grid[49]; pixel50.style.backgroundColor = grid[49];
    pixel51.value = grid[50]; pixel51.style.backgroundColor = grid[50];
    pixel52.value = grid[51]; pixel52.style.backgroundColor = grid[51];
    pixel53.value = grid[52]; pixel53.style.backgroundColor = grid[52];
    pixel54.value = grid[53]; pixel54.style.backgroundColor = grid[53];
    pixel55.value = grid[54]; pixel55.style.backgroundColor = grid[54];
    pixel56.value = grid[55]; pixel56.style.backgroundColor = grid[55];
    pixel57.value = grid[56]; pixel57.style.backgroundColor = grid[56];
    pixel58.value = grid[57]; pixel58.style.backgroundColor = grid[57];
    pixel59.value = grid[58]; pixel59.style.backgroundColor = grid[58];
    pixel60.value = grid[59]; pixel60.style.backgroundColor = grid[59];
    pixel61.value = grid[60]; pixel61.style.backgroundColor = grid[60];
    pixel62.value = grid[61]; pixel62.style.backgroundColor = grid[61];
    pixel63.value = grid[62]; pixel63.style.backgroundColor = grid[62];
    pixel64.value = grid[63]; pixel64.style.backgroundColor = grid[63];
});